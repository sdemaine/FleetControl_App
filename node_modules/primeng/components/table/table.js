                ...
                for (var i = 0; i < this.value.length; i++) {
                    ...
                    if (this.filters['global'] && !globalMatch && globalFilterFieldsArray) {
                        for (var j = 0; j < globalFilterFieldsArray.length; j++) {
                            var globalFilterField = globalFilterFieldsArray[j].field + '.' + globalFilterFieldsArray[j].nestedProperty || globalFilterFieldsArray[j].field || globalFilterFieldsArray[j];
        ...
        data.forEach(function (record, i) {
            ...
            for (var i_1 = 0; i_1 < _this.columns.length; i_1++) {
                ...
                if (column.exportable !== false && column.field) {
                    ...
                    if (column.hasOwnProperty('nestedProperty')){
                        cellData = _this.objectUtils.resolveFieldData(record, column.field + '.' + column.nestedProperty);
                    }
